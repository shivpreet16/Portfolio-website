  ...
  return (
    <div className="relative">
      <div className="hidden md:block">
        <article className="flex flex-col rounded-lg items-center flex-shrink-0 h-[70vh] w-[400px] md:w-[600px] xl:w-[700px] snap-center bg-[#292929] p-10 pt-5 hover:opacity-100 opacity-40 text-center transition-opacity duration-200 overflow-hidden ">
